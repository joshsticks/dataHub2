define([
	...
	var BenchPressView = Backbone.View.extend({
		...
		render: function () {
			...
			$.ajax({
					...
					var myScore = parseFloat($(response).find("ExhibitSession BenchPress").attr("Pounds")).toFixed(0);
					var meIndex = $.inArray( myScore, labelArray);
					labelArray[meIndex] = "My Score " + labelArray[meIndex];
					$("#yourScore").text("My Score " + myScore + " Pounds");
