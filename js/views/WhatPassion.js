define([
	...
	var WhatPassionView = Backbone.View.extend({
		...
		render: function () {
			...
			$.ajax({
					...
					var myScore = $(response).find("ExhibitSession WhatsYourPassion").attr("Passion");
					var meIndex = $.inArray( myScore, labelArray);
					labelArray[meIndex] = "My Choice " + labelArray[meIndex];
					$("#yourScore").text("My Choice " + myScore + "");
