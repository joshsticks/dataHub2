define([
	...
	var ShrinkView = Backbone.View.extend({
		...
		render: function () {
			...
			$.ajax({
					...
					var myScore = parseFloat($(response).find("ExhibitSession GetInBox").attr("LinearInches")).toFixed(0);
					var meIndex = $.inArray( myScore, labelArray);
					labelArray[meIndex] = "My Score " + labelArray[meIndex];
					$("#yourScore").text("My Score " + myScore + " Linear Inches");
